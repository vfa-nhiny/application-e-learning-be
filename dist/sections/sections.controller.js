...
let SectionsController = class SectionsController {
    ...
    async findByIdCourse(body) {
        try {
            ...
            return new response_dto_1.ResponseSuccess("COMMON.SUCCESS", section);
        }
        catch (error) {
    ...
    async createNewSection(body) {
        ...
        try {
            ...
            return new response_dto_1.ResponseSuccess("COMMON.SUCCESS", new section_dto_1.SectionDto(section));
        }
        catch (error) {
            return new response_dto_1.ResponseError("COMMON.ERROR.GENERIC_ERROR", error);
        }
